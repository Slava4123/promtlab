...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Free: 50 промптов, 3 коллекции, 1 команда (3 участника), 5 MCP-вызовов и 5 вставок через расширение в день, 1 цепочка из 3 шагов. Pro (599₽/мес ≈ 20₽/день): 500 промптов, 100 коллекций, 5 команд по 10 участников, 100 MCP-вызовов и 100 вставок в день, 5 цепочек по 10 шагов. Max (1299₽/мес ≈ 43₽/день): 10 000 промптов, 1 000 коллекций, 50 команд по 50 участников, 500 MCP-вызовов и 500 вставок в день, 100 цепочек по 50 шагов + условные ветвления. Годовой план — скидка 10%.",
    tags: ["тарифы", "оплата"],
  },
  {
  ...
  },
  {
    ...
    answer:
      "В Настройках → API-ключи создайте ключ, затем подключите MCP-сервер в клиенте. Полная инструкция с командами для Claude Code, Claude Desktop, Cursor и Windsurf, список из 24 инструментов, примеры запросов и решение типичных проблем — на отдельной странице /help/mcp.",
    tags: ["mcp", "claude"],
  },
  {
