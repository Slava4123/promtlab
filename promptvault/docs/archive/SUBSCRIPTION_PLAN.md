...
```sql
-- 000019_subscription_plans.up.sql — исходная схема.
-- ВАЖНО: миграция 000038_drop_ai_fields удалила колонки max_ai_requests_daily
-- и ai_requests_is_total. Актуальную схему смотри в models/subscription.go.
