...
| 14 | MCP-сервер + квоты | 4, 13 | Интеграции | ✅ |
| 14.1 | OAuth 2.1 + MCP autodeploy | 14 | MCP Registry | ✅ |
| 14.2 | GlitchTip + Sentry SDK | 12 | Observability | ✅ |
| 14.3 | Observability + Smart Insights + drill-down | 8, 14.2 | Analytics | ✅ |
| 15 | (планируется — см. `docs/FEATURES.md` Tier 2) | 14.3 | Следующая волна | ⏳ |
